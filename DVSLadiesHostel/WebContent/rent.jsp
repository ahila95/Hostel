	...
	<div class="agileits-main">
		...
		<form action="rent" method="post">
			<ul>
				...
				<li><input name="rnum" type="text" required></li>
			</ul>
			<ul>
			...
			<ul>
				<li class="text">Payment</li>
				<li><input name="payment" type="text" required></li>
			</ul>
			<ul>
				<li class="text">balance</li>
				<li><input name="balance" type="text" required></li>
			</ul>
