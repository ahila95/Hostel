...
<h1>DVS Room Details</h1>
  ...
  <br><a href="remark1.jsp" class="w3-bar-item w3-button"><i class="fa fa-plus-square-o" title="Home"></i></a>
...
<table class="container" id="myTable">
	...
	<tbody>
		...
		try{
			...
			PreparedStatement ps=con.prepareStatement("select * from remark");
